...
public class ObjectFactoryCompletionProvider extends com.intellij.codeInsight.completion.CompletionProvider<CompletionParameters> {
    ...
    protected void addCompletions(@NotNull CompletionParameters completionParameters, ProcessingContext processingContext, @NotNull CompletionResultSet completionResultSet) {
        ...
        if (phpClass != null) {
            ...
            for (Method method : ObjectFactoryUtil.getClassSetMethods(phpClass)) {
                if (uniqTracker.get(ObjectFactoryUtil.getAsPropertyName(method)) == null) {
    ...
    private LookupElementBuilder buildLookup(PhpClassMember field, PhpExpression position) {
        String lookupString = field instanceof Method ? ObjectFactoryUtil.getAsPropertyName((Method) field) : field.getName();
