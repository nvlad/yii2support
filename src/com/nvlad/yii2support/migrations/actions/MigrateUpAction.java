        ...
        if (migrationUp != null) {
            ...
            if (window != null) {
                ...
                if (content != null) {
                    ...
                    migrationUp.setConsoleView(consolePanel.getConsoleView());
                }
            }

            migrationUp.repaintComponent(getTree());

            ApplicationManager.getApplication().executeOnPooledThread(migrationUp);
        }
    }
